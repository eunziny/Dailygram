...
public class BoardController {
	...
	public ModelAndView newsfeed(@RequestParam String id) {
		...
		b.setWriter(id);
		b.setRow(0);
		List <Board> boardList= service.getNewsfeed(b);//10°³ + ÇØ´ç±ÛÀÇ type°¡Á®¿Â´Ù L,S,X ¼ÂÁßÇÏ³ª.
		
		mav.addObject("boardList", boardList);
		
		
		//´º½ºÇÇµå ¾È¿¡ µé¾î°¥ ÁÁ¾Æ¿ä, ´ñ±Û
/*		Like like = new Like(bseq, id);
   ...
   public ModelAndView friProfile(HttpServletRequest req ,
	   ...
	   System.out.println("±æÀÌ " + statusArr.length + "  1¹ø " + statusArr[0]);
